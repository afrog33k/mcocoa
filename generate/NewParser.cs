// Machine generated by peg-sharp 0.4.913.0 from generate/NewParser.peg.
using System;
...
internal sealed partial class NewParser
{
	public NewParser()
	{
		...
		m_nonterminals.Add("Inline", new ParseMethod[]{this.DoParseInline1Rule, this.DoParseInline2Rule, this.DoParseInline3Rule});
		...
		m_nonterminals.Add("Property", new ParseMethod[]{this.DoParseProperty1Rule, this.DoParseProperty2Rule, this.DoParseProperty3Rule, this.DoParseProperty4Rule, this.DoParseProperty5Rule});
		...
		m_nonterminals.Add("Retain", new ParseMethod[]{this.DoParseRetainRule});
		m_nonterminals.Add("Consumed", new ParseMethod[]{this.DoParseConsumedRule});
		...
		m_nonterminals.Add("Availability", new ParseMethod[]{this.DoParseAvailability1Rule, this.DoParseAvailability2Rule, this.DoParseAvailability3Rule, this.DoParseAvailability4Rule, this.DoParseAvailability5Rule});
		...
		m_nonterminals.Add("Unavailable", new ParseMethod[]{this.DoParseUnavailable1Rule, this.DoParseUnavailable2Rule});
		m_nonterminals.Add("Refcount", new ParseMethod[]{this.DoParseRefcountRule});
		...
		m_nonterminals.Add("Version", new ParseMethod[]{this.DoParseVersionRule});
		m_nonterminals.Add("VersionList", new ParseMethod[]{this.DoParseVersionListRule});
	...
	private State DoParseExtern1Rule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			...
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 1,
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "Refcount");});},
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, ";");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "C");});
	...
	private State DoParseInline1Rule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			...
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, ")");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "Refcount");},
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, ";");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");});
	...
	private State DoParseInline3Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
			...
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 1,
				delegate (State s2, List<Result> r2) {return DoSequence(s2, r2,
					delegate (State s3, List<Result> r3) {return DoRepetition(s3, r3, 0, 1,
						delegate (State s4, List<Result> r4) {return DoParse(s4, r4, "Consumed");});},
	...
	// Interface := Attribute? Deprecated? Availability? Refcount? '@interface' C InterfaceSig ('{' C)? '@interface' C InterfaceSig ('{' C Fields '}' C (';' S)?)? InterfaceMember* '@end' C
	...
	// Field := Volatile? Type Availability? Deprecated? ';' S
	...
	private State DoParseProperty3Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
	...
	private State DoParseProperty4Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
	...
	private State DoParseProperty5Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
	...
	// Type := Retain? PrimitiveType '(*)' S '(' S TypeList ')' S
	private State DoParseType1Rule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 1,
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "Retain");});},
			delegate (State s, List<Result> r) {return DoParse(s, r, "PrimitiveType");},
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "(*)");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");},
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "(");},
	...
	// Type := Retain? PrimitiveType '(^' Identifier? ')' S '(' S ArgList ')' S
	...
	// Type := Retain? PrimitiveType '(' S '*' S Identifier ')' S '(' S ArgList? ')' S
	...
	private State DoParseRetainRule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		...
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoChoice(s, r,
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "CF_RETURNS_RETAINED");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "NS_RETURNS_RETAINED");});},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");});
		
		if (_state.Parsed)
		{
			XmlElement _node = DoCreateElementNode("Retain", _start.Index, _state.Index - _start.Index, DoGetLine(_start.Index), DoGetCol(_start.Index), (from r in results where r.Value != null select r.Value).ToArray());
			XmlNode value = _node;
			_outResults.Add(new Result(this, _start.Index, _state.Index - _start.Index, m_input, value));
		}
	...
	private State DoParseConsumedRule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "CF_CONSUMED");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");});
		
		if (_state.Parsed)
		{
			XmlElement _node = DoCreateElementNode("Consumed", _start.Index, _state.Index - _start.Index, DoGetLine(_start.Index), DoGetCol(_start.Index), (from r in results where r.Value != null select r.Value).ToArray());
			XmlNode value = _node;
			_outResults.Add(new Result(this, _start.Index, _state.Index - _start.Index, m_input, value));
		}
	...
	// TypeSuffix := ('*' / 'const' / '__strong' / '__weak' / '__unsafe_unretained' / ArraySuffix+ / ProtocolList) S
	private State DoParseTypeSuffixRule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoChoice(s, r,
				...
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "__strong");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "__weak");},
				delegate (State s2, List<Result> r2) {return DoParseLiteral(s2, r2, "__unsafe_unretained");},
	...
	// Availability := 'NS_AVAILABLE' [_A-Z0-9]* S VersionList
	private State DoParseAvailability4Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "NS_AVAILABLE");},
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				delegate (State s2, List<Result> r2) {return DoParseRange(s2, r2, false, "_", "AZ09", null, "[_A-Z0-9]");});},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "VersionList");});
	...
	private State DoParseAvailability5Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "NS_CLASS_AVAILABLE");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "VersionList");});
	...
	// Deprecated := [A-Z]+ '_DEPRECATED' [_A-Z0-9]* C VersionList?
	private State DoParseDeprecated4Rule(State _state, List<Result> _outResults)
	{
		...
		_state = DoSequence(_state, results,
			...
			delegate (State s, List<Result> r) {return DoParse(s, r, "C");},
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 1,
				delegate (State s2, List<Result> r2) {return DoParse(s2, r2, "VersionList");});});
	...
	private State DoParseUnavailable1Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
	...
	private State DoParseUnavailable2Rule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "NS_UNAVAILABLE");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "C");});
	...
	private State DoParseRefcountRule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "NS_AUTOMATED_REFCOUNT_UNAVAILABLE");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");});
		
		if (_state.Parsed)
		{
			XmlElement _node = DoCreateElementNode("Refcount", _start.Index, _state.Index - _start.Index, DoGetLine(_start.Index), DoGetCol(_start.Index), (from r in results where r.Value != null select r.Value).ToArray());
			XmlNode value = _node;
			_outResults.Add(new Result(this, _start.Index, _state.Index - _start.Index, m_input, value));
		}
	...
	// Version := [_a-zA-Z0-9]+ S
	private State DoParseVersionRule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		...
		if (_state.Parsed)
		{
			XmlElement _node = DoCreateElementNode("Version", _start.Index, _state.Index - _start.Index, DoGetLine(_start.Index), DoGetCol(_start.Index), (from r in results where r.Value != null select r.Value).ToArray());
			XmlNode value = _node;
			_outResults.Add(new Result(this, _start.Index, _state.Index - _start.Index, m_input, value));
		}
	...
	private State DoParseVersionListRule(State _state, List<Result> _outResults)
	{
		State _start = _state;
		List<Result> results = new List<Result>();
		...
		_state = DoSequence(_state, results,
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, "(");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "S");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "Version");},
			delegate (State s, List<Result> r) {return DoRepetition(s, r, 0, 2147483647,
				delegate (State s2, List<Result> r2) {return DoSequence(s2, r2,
					delegate (State s3, List<Result> r3) {return DoParseLiteral(s3, r3, ",");},
					delegate (State s3, List<Result> r3) {return DoParse(s3, r3, "S");},
					delegate (State s3, List<Result> r3) {return DoParse(s3, r3, "Version");});});},
			delegate (State s, List<Result> r) {return DoParseLiteral(s, r, ")");},
			delegate (State s, List<Result> r) {return DoParse(s, r, "C");});
		
		if (_state.Parsed)
		{
			XmlElement _node = DoCreateElementNode("VersionList", _start.Index, _state.Index - _start.Index, DoGetLine(_start.Index), DoGetCol(_start.Index), (from r in results where r.Value != null select r.Value).ToArray());
			XmlNode value = _node;
			_outResults.Add(new Result(this, _start.Index, _state.Index - _start.Index, m_input, value));
		}
